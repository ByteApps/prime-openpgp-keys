...
- **Create keys** — random RSA (2048/3072/4096) or NIST P-521 (the strongest classical pair, ~256-bit security), or **"From seed"**: an Ed25519 key (with encryption subkey) derived from your wallet master seed. The same account number always re-creates the same key and fingerprint — on this device, or on a new one after a seed-phrase restore.
