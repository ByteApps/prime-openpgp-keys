...
See **[DEVELOPMENT.md](DEVELOPMENT.md)** for environment setup, the crypto stack, testing, and permissions.

## Learn more

- [DEVELOPMENT.md](DEVELOPMENT.md) — building, crypto internals, testing, permissions, project layout
